...
class DataScientistAgent(BaseAgent):
    ...
    def _generate_specialized_response(self, query: str) -> str:
        ...
        if any(term in query_lower for term in ["predict", "forecast", "model"]):
            return ("From a data science perspective, predictive modeling requires careful "
            ...
            return ("Data analysis should follow a systematic approach: exploratory data analysis, "
            ...
            return ("When examining relationships in data, distinguish between correlation and "
            ...
            return ("From a data science perspective, this problem requires systematic data "
